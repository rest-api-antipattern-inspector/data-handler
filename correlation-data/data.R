...
twitter_isBreakingSelfDescriptiveness, twitter_isForgettingHypermedia, twitter_isIgnoringCaching, twitter_isIgnoringMIMEType, twitter_isIgnoringStatusCode, twitter_isMisusingCookies, twitter_AmorphousURI, twitter_CRUDyURI, twitter_ContextlessResource, twitter_NonHierarchicalNodes, twitter_PluralisedNodes), nrow=4,
ncol=11,byrow = TRUE)

dimnames(mydata) = list(c("bitly", "imgur", "disqus", "twitter"),
